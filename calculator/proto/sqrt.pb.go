...
type SqrtRequest struct {
	...
	Number int32 `protobuf:"varint,1,opt,name=number,proto3" json:"number,omitempty"` // can negative
}
...
var file_sqrt_proto_rawDesc = []byte{
	...
	0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x42, 0x21, 0x5a, 0x1f, 0x67, 0x72, 0x70, 0x63, 0x2d,
